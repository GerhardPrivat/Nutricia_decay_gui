...
opts = {
    'py2exe': { "includes" : ["nutricialogo_png_rc","Vitaminator_ui_V5","sip", "matplotlib.backends",  "matplotlib.backends.backend_qt4agg",
                               "matplotlib.figure","pylab",
...
#my computer C:\Python27\Lib\site-packages\matplotlib
...
#setup(windows=[{"script" : "Vitaminator_0.1.py"}], options=opts,   data_files=data_files)
setup(windows=[{"script" : "Vitaminator_main_5.py"}], options=opts,  data_files=data_files)

#setup(
#    console = [
#        {
#            "script": "Vitaminator_ui_V4.py",
#         }
#    ],
#    windows = [
#        {
#            "script": "Vitaminator_main_5.py",   
#                   }
#    ]
#) 
